    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-6 p-2">
            <div class="mb-4 flex justify-end">
                <a href="{{route('roles')}}" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs
                font-medium
                ...
                <div class="divide-y divide-gray-200 pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                  <div>
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                      ...
                      <p>
                          To manage permissions, <a href="{{route('roles')}}" class="text-indigo-400 underline">click here</a>
                      </p>
                  </div>
